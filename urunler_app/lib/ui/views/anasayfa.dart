...
import 'package:urunler_app/ui/views/urun_detay.dart';

import '../../data/entities/urunler.dart';
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, indeks){
                ...
                return GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>UrunDetay(urun: urun)));
                  },
                  child: Card(
                    child: Row(
                      children: [
